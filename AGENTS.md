...
<!-- BEGIN:context-engine-agent-rules -->
## Context Engine (CCE)
...
<!-- END:context-engine-agent-rules -->

<!-- BEGIN:shadcn-agent-rules -->
## Shadcn
This project uses shadcn for all control panel components. The frontend is separate, but whenever working on the control panel, utilise shadcn as much as possible. Only deviate when a suitable component isn't available from shadcn.
<!-- END:shadcn-agent-rules -->

<!-- BEGIN:pnpm-agent-rules -->
## PNPM

Always use pnpm with this project. If the binary isn't installed, prompt the user to install it for you. Use pnpm dlx instead of npx. Use pnpm add or pnpm remove. etc.
