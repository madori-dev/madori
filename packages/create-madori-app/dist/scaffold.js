...
const REPO = 'michaelstokoe/madori';
const BRANCH = 'main';
...
export function scaffold(projectName) {
    ...
    try {
        execSync(`curl -sL "https://github.com/${REPO}/archive/refs/heads/${BRANCH}.tar.gz" | tar -xz --strip-components=1 -C "${projectDir}"`, { stdio: 'pipe' });
    }
    catch (err) {
    ...
    fs.writeFileSync(path.join(projectDir, 'users', 'admin.yaml'), `id: admin
