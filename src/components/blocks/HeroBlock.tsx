  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-36">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6">
        <div className="grid items-center gap-8 md:gap-12 grid-cols-12">
          ...
          {/* Left: copy */}
          <div className="col-span-full md:col-span-8 order-last md:order-first text-center md:text-left">
            <h1 className="font-heading text-balance text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              {title}
            </h1>

            {subtitle && (
              <p className="mt-6 mx-auto md:mx-0 max-w-2xl text-balance text-lg text-muted-foreground sm:text-xl">
                {subtitle}
              </p>
            )}

            {(primary_button_text || secondary_button_text) && (
              <div className="mt-10 flex flex-col items-center md:items-start gap-3 sm:flex-row sm:justify-center md:justify-start">
